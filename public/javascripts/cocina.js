...
/*COCINA*/
lines2.selectAll('.line-group3')
    .data(signal_cocina).enter()
    .append('g')
    .attr('class', 'line-group3')
    .on("mouseover", function(d, i) {
        chart_cocina.append("text")
      ...
      .on("mouseout", function(d) {
        chart_cocina.select(".title-text").remove();
      })
    .append('path')
    .attr("width","px")
    .attr('class', 'line')
...
lines2.selectAll("circle-group")
  ...
  .on("mouseover", function(d) {
      d3.select(this)
        ...
        .attr("y", d => yScale_cocina(d.value) - 10);
    })
    .on("mouseout", function(d) {
      d3.select(this)
        .style("cursor", "none")
      ...
      .attr("cy", d => yScale_cocina(d.value))
      .attr("r", circleRadius)
      .style('opacity', circleOpacity)
      .on("mouseover", function(d) {
          d3.select(this)
...
/*Cocina*/
var legend2 = chart_cocina.append("g")
